...
- Responses‑API + Websuche standardmäßig aktivieren (inkl. Scopes‑Check).
- Robusterer DOM‑Parser (stabile Locator‑Strategien, Tests).
- Einheitliche Nutzung von `openai_predictor.py` in `bot.py`.
- Optional: Poisson‑Backfill als weiche Sicherheitslinie (aber **nie 1:1** als Default).
